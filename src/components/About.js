          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body" style={myStyle}>
                Textutils gives you to analyze your text quickly and
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body" style={myStyle}>
                ...
                textUtils reports the numbers of the words and characters. Thus
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body" style={myStyle}>
                ...
                Chrome, Fireforx, Internet Explorer, Safari, Opera. It suits to
